...
$msg = "Thank you! Your payment request has been successfully received.";
$msg2 = "Your account activation request is pending administrator verification. Once verified, your status will update to active, and all downline rewards and commission tiers will be automatically processed.";
?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8" />
<title>MLM Platform - Payment Request Received</title>
<meta name="description" content="Thank you for your payment request." />
  ...
  <main class="flex-grow flex flex-col lg:flex-row relative z-10">
    ...
    <div class="hidden lg:flex lg:w-7/12 relative bg-transparent flex-col justify-between p-16 border-r border-[var(--border-color)]">
      ...
      <div class="my-auto relative z-10 max-w-lg">
        <span class="px-3 py-1 text-xs font-semibold text-indigo-600 bg-indigo-500/10 border border-indigo-500/20 rounded-full inline-block mb-6 tracking-wide">REQUEST RECEIVED</span>
        <h1 class="text-4xl lg:text-5xl font-extrabold text-[var(--text-primary)] leading-tight mb-6 tracking-tight">
          Your request has been successfully filed.
        </h1>
        <p class="text-[var(--text-secondary)] text-base lg:text-lg leading-relaxed mb-8">
          Your transaction details have been registered on our servers. Once the administrator approves the billing verification, your network benefits will resume.
        </p>
        ...
        <div class="grid grid-cols-3 gap-4 pt-4">
          ...
          <div class="custom-card p-4 rounded-xl border border-[var(--border-color)]">
            <div class="text-indigo-600 text-lg font-extrabold">INR</div>
      ...
      <div class="text-xs text-[var(--text-muted)] relative z-10">
        &copy; 2026 MLM Platform Inc. All rights reserved. Subscription Portal.
      </div>
    </div>
