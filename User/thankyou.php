...
print "
				<script language='javascript'>
					window.location = 'gateway.php?username=$userid';
				</script>
			";
exit;
}
...
<meta charset="utf-8" />
<title>Thank You | MLM Platform's Multi Level Marketing Script</title>
...
if($numrows==1) {
	...
	<input type="hidden" name="notify_url" value="http://www.MLM Platform.in/demo/cdecnyn/user/success.php?method=PAYPAL"> 
...
if($numrows==1) {
    ...
    <input type="hidden" name="ap_alerturl" value="http://www.MLM Platform.in/demo/cdecnyn/user/success.php?method=PAYZA">
...
<form action="https://solidtrustpay.com/handle.php" method="post">
    ...
    <input type="hidden" name="amount" value="<?php print $total ?>">
    <input type="hidden" name="notify_url" value="http://www.MLM Platform.in/demo/cdecnyn/user/success.php?method=SOLIDTRUSTPAY">
