...
$sql = "ALTER TABLE payu_payments ADD gateway VARCHAR(25) NOT NULL AFTER pckid";
mysqli_query($con, $sql);
$sql = "ALTER TABLE payu_payments ADD pckid DOUBLE NOT NULL AFTER date";
mysqli_query($con, $sql);
...
mysqli_query($con, $sql);
$sql = "ALTER TABLE payu_payments CHANGE price price DOUBLE NULL DEFAULT '0'";
mysqli_query($con, $sql);
