...
$total_notis = mlmp_pdo_count($pdo, "SELECT COUNT(*) FROM notifications");
$total_pages = max(1, (int)ceil($total_notis / $per_page));
if ($current_page > $total_pages) $current_page = $total_pages;
$offset = ($current_page - 1) * $per_page;

// Fetch all notifications for the grid
$notifications = mlmp_pdo_fetch_all($pdo, "SELECT * FROM notifications ORDER BY id DESC LIMIT $per_page OFFSET $offset");
?>
    ...
    <div class="p-6 bg-slate-50">
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="manage">
                ...
                <!-- Pagination Controls for Notifications Grid -->
                <?php if ($total_pages > 1): ?>
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6 px-1">
                    <div class="text-sm text-slate-500 font-medium">
                        Showing page <strong class="text-slate-700"><?php echo $current_page; ?></strong> of <strong class="text-slate-700"><?php echo $total_pages; ?></strong> &mdash; <?php echo $total_notis; ?> total
                    </div>
